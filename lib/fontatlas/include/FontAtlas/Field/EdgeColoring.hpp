 ...
 */
  void edgeColoringSimple(Shape &shape, float angleThreshold, unsigned long long seed = 0);
 ...
 */
  void edgeColoringInkTrap(Shape &shape, float angleThreshold, unsigned long long seed = 0);
 ...
 */
  void edgeColoringByDistance(Shape &shape, float angleThreshold, unsigned long long seed = 0);

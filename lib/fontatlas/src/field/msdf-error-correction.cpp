...
namespace msdfgen {
  ...
  template <int N>
  static void msdfErrorCorrectionInner(const BitmapRef<float, N> &sdf, const Shape &shape, const Projection &projection, float range, const MSDFGeneratorConfig &config) {
  ...
  template <int N>
  static void msdfErrorCorrectionShapeless(const BitmapRef<float, N> &sdf, const Projection &projection, float range, float minDeviationRatio, bool protectAll) {
  ...
  void msdfErrorCorrection(const BitmapRef<float, 3> &sdf, const Shape &shape, const Projection &projection, float range, const MSDFGeneratorConfig &config) {
    msdfErrorCorrectionInner(sdf, shape, projection, range, config);
  }
  void msdfErrorCorrection(const BitmapRef<float, 4> &sdf, const Shape &shape, const Projection &projection, float range, const MSDFGeneratorConfig &config) {
    msdfErrorCorrectionInner(sdf, shape, projection, range, config);
  }
  
  void msdfFastDistanceErrorCorrection(const BitmapRef<float, 3> &sdf, const Projection &projection, float range, float minDeviationRatio) {
    msdfErrorCorrectionShapeless(sdf, projection, range, minDeviationRatio, false);
  }
  void msdfFastDistanceErrorCorrection(const BitmapRef<float, 4> &sdf, const Projection &projection, float range, float minDeviationRatio) {
    msdfErrorCorrectionShapeless(sdf, projection, range, minDeviationRatio, false);
  }
  
  void msdfFastEdgeErrorCorrection(const BitmapRef<float, 3> &sdf, const Projection &projection, float range, float minDeviationRatio) {
    msdfErrorCorrectionShapeless(sdf, projection, range, minDeviationRatio, true);
  }
  void msdfFastEdgeErrorCorrection(const BitmapRef<float, 4> &sdf, const Projection &projection, float range, float minDeviationRatio) {
    msdfErrorCorrectionShapeless(sdf, projection, range, minDeviationRatio, true);
  }
...
// Legacy version
  ...
  inline static bool detectClash(const float *a, const float *b, float threshold) {
  ...
  template <int N>
  static void msdfErrorCorrectionInner_legacy(const BitmapRef<float, N> &output, const msdfVec2 &threshold) {

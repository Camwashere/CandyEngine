...
// Legacy API
  ...
  void rasterize(const BitmapRef<float, 1> &output, const Shape &shape, const msdfVec2 &scale, const msdfVec2 &translate, FillRule fillRule) {
    rasterize(output, shape, Projection(scale, translate), fillRule);
  }
  
  void distanceSignCorrection(const BitmapRef<float, 1> &sdf, const Shape &shape, const msdfVec2 &scale, const msdfVec2 &translate, FillRule fillRule) {
    distanceSignCorrection(sdf, shape, Projection(scale, translate), fillRule);
  }
  
  void distanceSignCorrection(const BitmapRef<float, 3> &sdf, const Shape &shape, const msdfVec2 &scale, const msdfVec2 &translate, FillRule fillRule) {
    distanceSignCorrection(sdf, shape, Projection(scale, translate), fillRule);
  }
  
  void distanceSignCorrection(const BitmapRef<float, 4> &sdf, const Shape &shape, const msdfVec2 &scale, const msdfVec2 &translate, FillRule fillRule) {
    distanceSignCorrection(sdf, shape, Projection(scale, translate), fillRule);
  }

...
namespace Candy::Graphics
{
  ...
  private:
    ...
    void ReflectStageOutputs(const spirv_cross::CompilerGLSL& compiler, ShaderData::Stage stage, const spirv_cross::SmallVector<spirv_cross::Resource, 8>& stageOutputs);

...
namespace Candy::Math{
        ...
        const Vector3 Direction3::directionVectors[27] = {Vector3::left, Vector3::right, Vector3::up,
                                                          Vector3::down, Vector3::downLeft,
                                                          Vector3::downRight, Vector3::upLeft,
                                                          Vector3::upRight, Vector3::forward, Vector3::back,
                                                          Vector3::upForward, Vector3::upBack, Vector3::upLeftForward,
                                                          Vector3::upLeftBack, Vector3::upRightForward,
                                                          Vector3::upRightBack,
                                                          Vector3::downForward, Vector3::downBack,
                                                          Vector3::downLeftForward,
                                                          Vector3::downLeftBack, Vector3::downRightForward,
                                                          Vector3::downRightBack, Vector3::leftBack, Vector3::rightBack,
                                                          Vector3::leftForward, Vector3::rightForward,
                                                          Vector3::zero};
        
        const Direction Direction3::directionArray[3][3][3] = {
                { // leftX
                ...
                { // rightX
                        {DOWN_RIGHT_BACK, DOWN_RIGHT, DOWN_RIGHT_FORWARD},
                        {RIGHT_BACK, RIGHT, RIGHT_FORWARD},
                        {UP_RIGHT_BACK, UP_RIGHT, UP_RIGHT_FORWARD},
                }
        };
        
        const Direction Direction3::oppositeDirections[27] = {
                RIGHT, LEFT, DOWN,
                UP, UP_RIGHT,
                UP_LEFT, DOWN_RIGHT,
                DOWN_LEFT, BACK, FORWARD,
                DOWN_BACK, DOWN_FORWARD, DOWN_RIGHT_BACK,
                DOWN_RIGHT_FORWARD, DOWN_LEFT_BACK,
                DOWN_LEFT_FORWARD,
                UP_BACK, UP_FORWARD,
                UP_RIGHT_BACK,
                UP_RIGHT_FORWARD, UP_LEFT_BACK,
                UP_LEFT_FORWARD, RIGHT_FORWARD, LEFT_FORWARD,
        ...
        Direction3::operator int8() const { return value; }

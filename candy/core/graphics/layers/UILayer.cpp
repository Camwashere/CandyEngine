...
namespace Candy
{
    ...
    void UILayer::OnAttach()
    {
        ...
        GLFWwindow* window = static_cast<GLFWwindow*>(app.MainWindowReference()->ref);
    ...
    void UILayer::End()
    {
        ...
        ImGuiIO& io = ImGui::GetIO();
        Application& app = Application::Instance();
        io.DisplaySize = ImVec2((float)app.MainWindowReference()->GetWidth(), (float)app.MainWindowReference()->GetHeight());
    ...
    uint32 UILayer::GetActiveWidgetID() const
    {

...
namespace Candy
{
    ...
    namespace Graphics{
        ...
        void Renderer2D::BeginScene(const Camera& camera, const Math::Matrix4& transform)
        {
            ...
            s_Data.CameraBuffer.ViewProjection = camera.GetProjectionMatrix() * Math::Matrix4::Invert(transform);
            s_Data.CameraUniformBuffer->SetData(&s_Data.CameraBuffer, sizeof(Renderer2DData::CameraData));
        ...
        void Renderer2D::DrawQuad(const Math::Vector3& position, const Math::Vector2& size, const Math::Vector4& color)
        {
            ...
            Math::Matrix4 transform = Math::Matrix4::Translation(position)
                                  * Math::Matrix4::Scaled({ size.x, size.y, 1.0f });
        ...
        void Renderer2D::DrawRotatedQuad(const Math::Vector3& position, const Math::Vector2& size, float rotation, const Math::Vector4& color)
        {
            ...
            Math::Matrix4 transform = Math::Matrix4::Translation(position)
                                  * Math::Matrix4::Rotated(Math::ToRadians(rotation), { 0.0f, 0.0f, 1.0f })
                                  * Math::Matrix4::Scaled({ size.x, size.y, 1.0f });
        ...
        /*void Renderer2D::DrawString(const std::string& string, SharedPtr<Font> font, const Math::Matrix4& transform, const TextParams& textParams, int entityID)
        {
            ...
            for (size_t i = 0; i < string.size(); i++)
            {
                ...
                Math::Vector2 texCoordMin((float)al, (float)ab);
                Math::Vector2 texCoordMax((float)ar, (float)at);
                
                double pl, pb, pr, pt;
                glyph->getQuadPlaneBounds(pl, pb, pr, pt);
                Math::Vector2 quadMin((float)pl, (float)pb);
                Math::Vector2 quadMax((float)pr, (float)pt);
                
                quadMin *= fsScale, quadMax *= fsScale;
                quadMin += Math::Vector2(x, y);
                quadMax += Math::Vector2(x, y);
                
                float texelWidth = 1.0f / fontAtlas->GetWidth();
                float texelHeight = 1.0f / fontAtlas->GetHeight();
                texCoordMin *= Math::Vector2(texelWidth, texelHeight);
                texCoordMax *= Math::Vector2(texelWidth, texelHeight);
                
                // render here
                s_Data.TextVertexBufferPtr->Position = transform * Math::Vector4(quadMin, 0.0f, 1.0f);
                s_Data.TextVertexBufferPtr->Color = textParams.Color;
                s_Data.TextVertexBufferPtr->TexCoord = texCoordMin;
                s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;
                
                s_Data.TextVertexBufferPtr->Position = transform * Math::Vector4(quadMin.x, quadMax.y, 0.0f, 1.0f);
                s_Data.TextVertexBufferPtr->Color = textParams.Color;
                s_Data.TextVertexBufferPtr->TexCoord = { texCoordMin.x, texCoordMax.y };
                s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;
                
                s_Data.TextVertexBufferPtr->Position = transform * Math::Vector4(quadMax, 0.0f, 1.0f);
                s_Data.TextVertexBufferPtr->Color = textParams.Color;
                s_Data.TextVertexBufferPtr->TexCoord = texCoordMax;
                s_Data.TextVertexBufferPtr->EntityID = entityID;
                s_Data.TextVertexBufferPtr++;
                
                s_Data.TextVertexBufferPtr->Position = transform * Math::Vector4(quadMax.x, quadMin.y, 0.0f, 1.0f);
                s_Data.TextVertexBufferPtr->Color = textParams.Color;
       ...
       /* void Renderer2D::DrawString(const std::string& string, const Math::Matrix4& transform, const TextComponent& component, int entityID)
        {
